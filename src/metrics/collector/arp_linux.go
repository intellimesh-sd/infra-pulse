...
/*var (
	arpDeviceInclude = flag.String("collector.arp.device-include", "", "Regexp of arp devices to include (mutually exclusive to device-exclude).")
	arpDeviceExclude = flag.String("collector.arp.device-exclude", "", "Regexp of arp devices to exclude (mutually exclusive to device-include).")
	arpNetlink       = flag.Bool("collector.arp.netlink", true, "Use netlink to gather stats instead of /proc/net/arp.")
	arpDeviceInclude = flag.Bool("collector.arp.device-include", "Regexp of arp devices to include (mutually exclusive to device-exclude).").String()
	arpDeviceExclude = flag.Bool("collector.arp.device-exclude", "Regexp of arp devices to exclude (mutually exclusive to device-include).").String()
	arpNetlink       = flag.Bool("collector.arp.netlink", "Use netlink to gather stats instead of /proc/net/arp.").Default("true").Bool()
)*/
