...
var (
	/*netclassIgnoredDevices = flag.String("collector.netclass.ignored-devices", "^$",
		"Regexp of net devices to ignore for netclass collector.")
	netclassInvalidSpeed = flag.Bool("collector.netclass.ignore-invalid-speed", false,
		"Ignore devices where the speed is invalid. This will be the default behavior in 2.x.")
	netclassNetlink = flag.Bool("collector.netclass.netlink", false,
