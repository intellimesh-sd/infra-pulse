...
var (
	/*collectorQdisc = flag.String("collector.qdisc.fixtures", "",
		"test fixtures to use for qdisc collector end-to-end testing")
	collectorQdiscDeviceInclude = flag.String("collector.qdisc.device-include", "",
		"Regexp of qdisc devices to include (mutually exclusive to device-exclude).")
	oldCollectorQdiskDeviceInclude = flag.String("collector.qdisk.device-include", "",
		"DEPRECATED: Use collector.qdisc.device-include")
	collectorQdiscDeviceExclude = flag.String("collector.qdisc.device-exclude", "",
		"Regexp of qdisc devices to exclude (mutually exclusive to device-include).")
	oldCollectorQdiskDeviceExclude = flag.String("collector.qdisk.device-exclude", "",
		"DEPRECATED: Use collector.qdisc.device-exclude")*/

	collectorQdisc                 = ""
	collectorQdiscDeviceInclude    = ""
	oldCollectorQdiskDeviceInclude = ""
	collectorQdiscDeviceExclude    = ""
	oldCollectorQdiskDeviceExclude = ""
)
...
func NewQdiscStatCollector() (Collector, error) {
	if oldCollectorQdiskDeviceInclude != "" {
		if collectorQdiscDeviceInclude == "" {
			klog.V(2).Info("msg", "--collector.qdisk.device-include is DEPRECATED and will be removed in 2.0.0, use --collector.qdisc.device-include")
	...
	if oldCollectorQdiskDeviceExclude != "" {
		if collectorQdiscDeviceExclude == "" {
			klog.V(2).Info("msg", "--collector.qdisk.device-exclude is DEPRECATED and will be removed in 2.0.0, use --collector.qdisc.device-exclude")
