...
var (
	sysctlInclude     = make([]string, 0)
	sysctlIncludeInfo = make([]string, 0)

	/*sysctlInclude     = flag.Bool("collector.sysctl.include", "Select sysctl metrics to include").Strings()
	sysctlIncludeInfo = flag.Bool("collector.sysctl.include-info", "Select sysctl metrics to include as info metrics").Strings()*/
