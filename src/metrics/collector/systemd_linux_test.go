...
func TestSystemdIgnoreFilter(t *testing.T) {
	...
	filtered := filterUnits(fixtures[0], includePattern, excludePattern)
...
func TestSystemdIgnoreFilterDefaultKeepsAll(t *testing.T) {
	...
	filtered := filterUnits(fixtures[0], collector.systemdUnitIncludePattern, collector.systemdUnitExcludePattern)
